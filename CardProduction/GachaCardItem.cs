...
public class GachaCardItem : MonoBehaviour
{
    ...
    /// 크리쳐 카드 생성.
    /// </summary>
    public void CreateCard(WEB_SHOP_UI_PRICETYPE._enWebListName kPayType, enCardGrade type, Texture CardTexture, CCreatureDetail CreatureDetail, 
    ...
    /// 아이템 카드 생성
    /// </summary>
    public void CreateCard(WEB_SHOP_UI_PRICETYPE._enWebListName kPayType, enCardGrade CardGrade, Texture CardTexture, 
    ...
    /// </summary>
    public void ChangeItemCard(WEB_SHOP_UI_PRICETYPE._enWebListName kPayType, enCardGrade grade, Texture CardTexture, CItem item, DATA_ITEM_NEW itemTableData)
    {
        _CardGrade = grade;
        _CItem = item;
        _ItemTableData = itemTableData;
